...
namespace App.Scripts.Scenes.SceneChess.Installers
{
    public class InstallerChessServices : MonoInstaller
    {
        ...
        public override void InstallBindings(ServiceContainer serviceContainer)
        {
            ...
            serviceContainer.SetService<IChessPathFinder, ChessPathFinder>(new ChessPathFinder());
            serviceContainer.SetService<IChessGridNavigator, ChessGridNavigator>(new ChessGridNavigator(serviceContainer.Get<IChessPathFinder>()));
        }
    }
}